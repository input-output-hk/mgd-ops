...
in {
  ...
  in
    ...
    // (mkNodes 18 "client-ssd-eu-%02d" "10.200.21.%d" [(type "r5.4xlarge") nomad-client perf-ssd-class (ebs 40) eu-central-1b])
    // (mkNodes 17 "client-ssd-ap-%02d" "10.200.22.%d" [(type "r5.4xlarge") nomad-client perf-ssd-class (ebs 40) ap-southeast-2b])
    // (mkNodes 17 "client-ssd-us-%02d" "10.200.23.%d" [(type "r5.4xlarge") nomad-client perf-ssd-class (ebs 40) us-east-1d])
